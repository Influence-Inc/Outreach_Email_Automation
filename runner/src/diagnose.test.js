...
// Locks the diagnose() pattern → { reason, fix } mapping so a raw adb /
// backend error surfaces as a compact, actionable line instead of a stack
// trace. Add a fixture per new failure mode we hit for real. Android-only, no
// Appium — every device-side case here is adb-shaped.
